    ...
    <body>
        ...
        <div class="content">
            ...
            if(isset($_POST['update']))
            {
                ...
                $update_user = "update students set student_name='$user_name2',student_email='$user_email2',student_password='$user_pass2',student_permission='$user_access2' where student_id='$user_id2'";
