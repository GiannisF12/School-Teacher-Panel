    ...
    function insert_user() 
{
    ...
    if(isset($_POST['insert_user']))
    {
        ...
        $insert_user = "insert into students (student_name,student_email,student_password,student_permission) values ('$user_name','$user_email','$user_pass','$user_access')";
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> Dashboard / Insert Student
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-money fa-fw"></i> Insert Student
                            </h3>
                        </div>
