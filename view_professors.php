        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> Dashboard / View Professors
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-tags"></i>  View Professors
                            </h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $i=0;
                                            $get_users = "SELECT * from users where users.permission = 'Professor' ";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>    
                                                    <a href="edit_professor.php?edit_user=<?php echo $user_id2; ?>">
                                                        <i class="fa fa-pencil"></i> Edit
                                                    </a> 
                                                </td>
                                                <td> 
                                                    <a href="view_professors.php?delete_user=<?php echo $user_id2; ?>">
